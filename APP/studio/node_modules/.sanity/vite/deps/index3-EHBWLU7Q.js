...
import "./chunk-E6GCDJP7.js";
import "./chunk-UGVBN62Q.js";
import "./chunk-JDBUVPKY.js";
import {
  require_jsx_runtime
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-F4GSIGBT.js")),
  document: (0, import_react.lazy)(() => import("./pane-QBP6ZSH2.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-QBP6ZSH2.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-MD642WOT.js"))
};
...
var StyledPaneLayout = lt(PaneLayout)`
  min-height: 100%;
  min-width: 320px;
`;
...
//# sourceMappingURL=index3-EHBWLU7Q.js.map
